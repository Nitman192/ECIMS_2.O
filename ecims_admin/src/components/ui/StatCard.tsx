...
const trendMap: Record<Trend, { icon: typeof FiArrowUpRight; className: string }> = {
  up: { icon: FiArrowUpRight, className: 'text-emerald-600 dark:text-emerald-400' },
  down: { icon: FiArrowDownRight, className: 'text-rose-600 dark:text-rose-400' },
  neutral: { icon: FiMinus, className: 'text-slate-500 dark:text-slate-400' },
};
    ...
    <Card className="h-full p-5">
      <div className="flex items-start justify-between gap-4">
        <div className="space-y-2">
          ...
          <p
            className={`inline-flex items-center gap-1 text-xs font-medium ${trendMeta.className}`}
          >
