    ...
    <header className="sticky top-0 z-30 border-b border-slate-200/80 bg-white/85 backdrop-blur-md dark:border-slate-800/80 dark:bg-slate-950/80">
      <Container className="flex h-16 items-center gap-3 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-1 justify-center">
          <label className="group hidden w-full max-w-2xl items-center gap-2 rounded-xl border border-slate-200 bg-slate-50 px-3 py-2.5 transition focus-within:border-cyan-500/60 focus-within:bg-white dark:border-slate-700 dark:bg-slate-900 dark:focus-within:border-cyan-400/60 dark:focus-within:bg-slate-900 sm:flex">
            <FiSearch className="text-slate-400 transition group-focus-within:text-cyan-600 dark:group-focus-within:text-cyan-400" />
            <input
              type="text"
              placeholder="Search incidents, endpoints, users..."
